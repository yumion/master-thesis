...
\begin{figure}
	...
	\label{fig:2d_cnn_preprocessing}
\end{figure}
...
\fig{2d_cnn_preprocessing}で緑のプロットが前処理を何も行わない場合のROC曲線でとなる．一番認識精度が低かった．また\fig{no_preprocess}のように腫瘍は87\%の精度で検出できているが，正常は40\%の精度でしか検出できていなかった．
