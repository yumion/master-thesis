...
\begin{figure}[H]
    ...
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[width=0.7\linewidth]{figure/chapter4/2号機CAD前}
        \subcaption{3DCAD image of prototype No.2}
    \end{minipage}
    \begin{minipage}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figure/chapter4/2号機外観}
        \subcaption{Appearance of Prototype No.2}
    \end{minipage}
    \caption{Overview of prototype No.2}
    \label{fig:2号機外観}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{ccccc}\toprule
        ...
        bottle(350 ml) & 16.5 cm $\times$  $\phi$ &  & \multirow{2}{*}{8880} & Empty \\ 
