...
・把持機構の自由度を改善するために，人間の手でも重要な機能を有する手首機構に着目し，アクチュエータを増加させる．%ここは人間の手首が重要ですという背景になるので，なぜ手首を模擬すると嬉しいのかきちんと書くことが大事．なんなら前のセクションにまとめて改善に際し着目した点を研究背景として列挙した後，参照する形で述べてもいいと思います．
...
%要求仕様が多すぎるのと，簡潔でないので，もう少しまとめた方があとあと要求仕様を本当にきちんと満たしているか１対１で検討しやすい．
...
\begin{figure}
    ...
    \label{fig:2号機CAD}
    %改善に際し着目した点を図中に記載する方がよい．このCADデータだけでは，何が言いたいのかよくわからない．何が言いたいかよくわからない図は載せなくて良い．具体的には自由度と識別の問題があったので，自由度が増えましたよみたいなことを言ってるとよい(１ー＞３自由度になりましたって強調)
\end{figure}
...
%↑なぜ？３章の課題に書いてあるなら，きちんと書く．ref\section{~}では，主観カメラでの強化学習は学習が収束しないことを確認した．など
...
\begin{table}
    ...
    \begin{tabular}{cccc}\toprule
        ...
        Vertical swing servo & 011 & 0 / 100 & 0 / 011 \\ 
