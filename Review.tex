...
\begin{figure}[H]
	...
	\begin{minipage}{0.4\columnwidth}
		\centering
		\includegraphics[clip, width=\linewidth]{fig/chapter2/vae}
		\subcaption{Variational Auto Encoder Structure}
	\end{minipage}
	\begin{minipage}{0.4\columnwidth}
		\centering
		\includegraphics[clip, width=\linewidth]{fig/chapter2/vae_encoder}
		\subcaption{Variational encoder}
	\end{minipage}
...
VAEをベースに半教師あり学習のモデルを作ることができる\cite{M2model}，半教師あり学習の，モデルの最適化手法は，教師ラベルがある場合と，教師ラベルがない場合の2通りに分けて行われる\cite{narayanaswamy2017learning}．まず教師ラベルがある場合は
