...
畳み込みニューラルネットワーク(Convolutional Neural Network: CNN)は，1998年にLeNetと呼ばれるネットワークで初めて実装された\cite{LeNet}．
\begin{figure}[H]
	\centering
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{fig/conv_ex0}
