...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{figure/Review/LeNet}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\columnwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/Review/conv_ex1}
		\subcaption{}
		\label{fig:conv_ex1}
	\end{minipage}
	\hspace{10truemm}
	\begin{minipage}{0.45\columnwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/Review/conv_ex2}
		\subcaption{}
		\label{fig:conv_ex2}
	\end{minipage}
	\begin{minipage}{0.45\columnwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/Review/conv_ex3}
		\subcaption{}
		\label{fig:conv_ex3}
	\end{minipage}
	\hspace{10truemm}
	\begin{minipage}{0.45\columnwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/Review/conv_ex4}
		\subcaption{}
		\label{fig:conv_ex4}
	\end{minipage}
...
\begin{figure}[H]
	...
	\begin{minipage}[b]{0.4\columnwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/Review/pooling_ex1}
		\subcaption{}
	...
	\begin{minipage}[b]{0.4\columnwidth}
		\centering
		\includegraphics[width=\linewidth]{figure/Review/pooling_ex2}
		\subcaption{}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figure/Review/RL_framework}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figure/Introduction/Dmitry}
