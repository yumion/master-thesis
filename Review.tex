...
\section{教師なし学習}
機械学習の手法には，\ref{sec:NeuralNetwork}〜\ref{sec:3Danalysis}節で説明したように，ラベルの貼られているデータセットを用いて学習する教師あり学習と，その反対に，データセットはあっても，そのデータセットの特性を示したラベルが与えられていない場合のデータセットを用いて学習する教師なし学習がある．\cite{RadfordMC15}本節では教師なし学習について述べる．
